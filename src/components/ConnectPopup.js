...
export default function ConnectPopup({ popupVisible, setPopupVisible }) {
    ...
    return (
        <Popup className="popup--connect" popupShow={popupVisible} setPopupShow={setPopupVisible}>
                    ...
                    <div className="popup__checkboxes">
                        <button className={"popup__checkbox" + (checkboxes.metamask ? " active" : "")} onClick={() => setCheckboxes({ metamask: true, walletConnect: false })}>
                            <div className="popup__checkbox-icon-wrapper">
                                <img src={metamaskIcon} className="popup__checkbox-icon" alt="metamask" />
                            </div>
                            <span>Metamask</span>
                        </button>
                        <button className={"popup__checkbox" + (checkboxes.walletConnect ? " active" : "")} onClick={() => setCheckboxes({ metamask: false, walletConnect: true })}>
                            <div className="popup__checkbox-icon-wrapper">
                                <img src={wcIcon} className="popup__checkbox-icon" alt="wallet connect" />
                            </div>
            ...
            <button className="popup__button button button--transparent">Connect</button>
        </Popup>
    );
}
